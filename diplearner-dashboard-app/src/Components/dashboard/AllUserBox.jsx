...
const AllUserBox = () => {
  return (
    <div className="min-w-[800px] max-w-full h-auto p-1">
      <div className="w-full h-auto p-2 shadow-3xl rounded-md flex flex-row gap-5 items-center align-middle justify-between">
        ...
        <div>USER</div>
        <div>PREMIUM</div>
        <div className="text-gray-800 bg-gray-50 p-2 cursor-pointer rounded-md ">Contact</div>
      </div>
    </div>
  );
};
